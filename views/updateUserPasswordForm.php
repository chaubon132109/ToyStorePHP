     ...
     <div class="container">
        ...
        <div class="personal-info">
            <div class="input-container">
                <form action="../controllers/updatePassword_controller.php" method="post" onsubmit="return validateForm()">
                    <div class="input">
                        <label class="label">Mật khẩu cũ : </label>
                        <input type="password" class="input_text" name="oldpassword" id="oldpassword" placehoder="Nhập mật khẩu cũ">
                    </div>
                    <div class="input">
...
<script>
    function validateForm() {
        ...
        // Kiểm tra mật khẩu cũ phải giống mật khẩu người dùng
        if (<?=password_verify($oldPassword,$_SESSION['password'])?> || <?=$oldPassword ==$_SESSION['password']?> ){
