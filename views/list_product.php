        ...
        <div class="sidebar">
            ...
            <?php if (isset($categories)): ?>
                <li style="border-bottom:none;padding:0px;">
                    <a style="margin-bottom:15px;font-size:20px;color:red;" href="../controllers/listProduct_controller.php">Danh Mục</a>
                </li>
                <?php foreach ($categories as $category): ?>
                    <li>
                        <a href="../controllers/productCategory_controller.php?id=<?php echo $category['category_id']; ?>">
