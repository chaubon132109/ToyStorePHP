     ...
     <div class="container">
        <div class="sidebar">
            <ul class="category-menu">
                <li style = "border-bottom:none;padding : 0px;" ><a style = "margin-bottom : 15px;font-size : 20px;color : red;" href="../controllers/listProduct_controller.php">Danh Mục</a></li>
                <?php foreach ($categories as $category): ?>
                    <li><a href="../controllers/productCategory_controller.php?id=<?php echo $category['category_id']; ?>"><?php echo $category['category_name']; ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
        <div class="product-details">
            <h5 style = "font-size : 16px; color: red; text-decoration : solid; margin-bottom : 20px">Danh mục > <?=$categoryName ?></h5>
